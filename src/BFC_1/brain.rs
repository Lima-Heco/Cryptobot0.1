pub mod BFC_1_brain {
    ...
    pub fn bfcbrain(btc_price: Arc<RwLock<get_bitcoin::btcprice>>, should_stop_clone: Arc<Mutex<bool>>, infobot: Arc<Mutex<marqueures>>) {
        println!("bot started...");
        ...
        loop {
            ...
            select_algo(&view, btc_price_clone, wait_cl, info);
